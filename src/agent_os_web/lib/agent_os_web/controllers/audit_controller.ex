defmodule AgentOS.Web.Controllers.AuditController do
  ...
  @spec trail(Plug.Conn.t(), map()) :: Plug.Conn.t()
  def trail(conn, %{"pipeline_id" => pipeline_id}) do
  ...
  @spec proof(Plug.Conn.t(), map()) :: Plug.Conn.t()
  def proof(conn, %{"pipeline_id" => pipeline_id, "stage" => stage}) do
